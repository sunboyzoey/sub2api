...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	salesService := service.NewSalesService(salesRepository, userRepository, groupRepository, userSubscriptionRepository, apiKeyRepository, subscriptionService, apiKeyService)
	...
	adminHandlers := handler.ProvideAdminHandlers(dashboardHandler, adminUserHandler, groupHandler, accountHandler, adminAnnouncementHandler, dataManagementHandler, backupHandler, oAuthHandler, openAIOAuthHandler, geminiOAuthHandler, antigravityOAuthHandler, proxyHandler, adminRedeemHandler, promoHandler, settingHandler, opsHandler, systemHandler, adminSubscriptionHandler, adminUsageHandler, userAttributeHandler, errorPassthroughHandler, tlsFingerprintProfileHandler, adminAPIKeyHandler, scheduledTestHandler, channelHandler, channelMonitorHandler, channelMonitorRequestTemplateHandler, salesHandler, contentModerationHandler, paymentHandler, affiliateHandler)
	...
	poolStatusService := service.NewPoolStatusService(db)
	handlerSettingHandler := handler.ProvideSettingHandler(settingService, poolStatusService, buildInfo, notificationEmailService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, apiKeyHandler, usageHandler, redeemHandler, subscriptionHandler, announcementHandler, channelMonitorUserHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler, totpHandler, handlerSalesHandler, handlerPaymentHandler, paymentWebhookHandler, availableChannelHandler, idempotencyCoordinator, idempotencyCleanupService)
