...
// SetPoolStatusService attaches the public pool status service.
func (h *SettingHandler) SetPoolStatusService(poolStatus *service.PoolStatusService) {
	h.poolStatus = poolStatus
}
