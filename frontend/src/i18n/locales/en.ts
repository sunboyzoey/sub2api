export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportHint: 'Upload an exported JSON file, or a CPA / Codex OAuth JSON or ZIP file to auto-convert and import accounts in bulk.',
      dataImportWarning: 'JSON exports can be imported as-is. CPA / Codex OAuth JSON and ZIP files are auto-converted into the existing OpenAI OAuth account shape and will inherit defaults from the selected template account, or from the latest grouped OpenAI OAuth account when no template is chosen.',
      dataImportFile: 'Data file',
      dataImportFileTypes: 'JSON (.json) / ZIP (.zip)',
      dataImportFilesSelected: '{count} files selected',
      dataImportDomainFilter: 'Email domain filter',
      dataImportDomainFilterPlaceholder: 'For example: outlook.com, gmail.com',
      dataImportDomainFilterHint: 'Optional. Only applies to CPA / Codex OAuth JSON and ZIP imports; leave empty to import all domains.',
      dataImportTemplateAccount: 'Template account',
      dataImportTemplateAccountAuto: 'Auto-select latest grouped OpenAI OAuth account',
      dataImportTemplateAccountHint: 'Optional. Only applies to CPA / Codex OAuth JSON and ZIP imports; when set, the import will inherit that account\'s groups, concurrency, priority, rate multiplier, and auto-pause-on-expiry settings first.',
      ...
      dataImportResultSummary: 'Proxies created {proxy_created}, reused {proxy_reused}, failed {proxy_failed}; Accounts created {account_created}, skipped existing {account_skipped_existing}, failed {account_failed}',
      dataImportErrors: 'Error Details',
      dataImportSuccess: 'Import completed: accounts {account_created}, skipped existing {account_skipped_existing}, failed {account_failed}',
