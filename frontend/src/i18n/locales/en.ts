export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      dataImportHint: 'Upload an exported JSON file, or a CPA OAuth ZIP/JSON file to auto-convert and import accounts in bulk.',
      dataImportWarning: 'JSON exports can be imported as-is. CPA ZIP/JSON files are auto-converted into the existing OpenAI OAuth account shape and will inherit defaults from the selected template account, or from the latest grouped OpenAI OAuth account when no template is chosen.',
      ...
      dataImportDomainFilterHint: 'Optional. Only applies to CPA ZIP/JSON imports; leave empty to import all domains.',
      dataImportTemplateAccount: 'Template account',
      dataImportTemplateAccountAuto: 'Auto-select latest grouped OpenAI OAuth account',
      dataImportTemplateAccountHint: 'Optional. Only applies to CPA ZIP/JSON imports; when set, the import will inherit that account\'s groups, concurrency, priority, rate multiplier, and auto-pause-on-expiry settings first.',
